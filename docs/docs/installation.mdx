...
:::tip
`./scripts/install-agents.sh install` configures this server **and** the master skill for pi, Cursor, and Codex in one idempotent command (`check` verifies, `uninstall` removes).
:::
