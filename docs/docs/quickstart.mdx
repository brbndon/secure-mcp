...
Install first: clone, build, and run `scripts/install-agents.sh install` (or `.ps1` on Windows), then restart your agent. The server requires MCP protocol `2026-07-28`.
