...
The output is fully static: HTML, local search, sitemap/robots metadata when a site URL is available, and AI-readable `llms.txt` files. No MCP server configuration or repository access is needed to build the documentation site.
