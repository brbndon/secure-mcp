...
<CardGroup cols={2}>
  <Card title="Install and connect" href="/installation" icon="rocket">
    Build the server, provide a local license key, and connect it to Claude, Cursor, Codex, or another stdio client.
  </Card>
  <Card title="Run the audit workflow" href="/quickstart" icon="workflow">
    Follow the multi-phase sequence from inventory to confirmed findings and a human-facing remediation plan.
  </Card>
  <Card title="Explore the tool surface" href="/tools" icon="scan-search">
    See what each tool reads, returns, and contributes to the final report.
  </Card>
  <Card title="Host these docs" href="/hosting" icon="github">
    The repository includes a GitHub Pages workflow for publishing the Blume site on every main-branch push.
  </Card>
</CardGroup>
...
<Card title="Read the design notes" href="/architecture" icon="book-open">
