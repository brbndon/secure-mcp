...
The contract is intentionally stable: agents can pass findings between phases without converting prose into a new shape each time. See [Tool design](/tool-design) for registration patterns and response envelopes.
